        ...
        Column(
            ...
            Card(modifier = Modifier.fillMaxWidth(0.9f)) {
                Column(
                    ...
                    Tips(title ="요즘 감정 메모해오기" ,
                        description = "하고 싶은말, 고민을 간단히 정리해보세요.")
                    Spacer(modifier = Modifier.height(10.dp))
                    Tips(title ="10분 일찍 도착하기" ,
                        description = "서두르지 않으면 마음도 더 편해져요.")
                    Spacer(modifier = Modifier.height(10.dp))
                    Tips(title ="심리검사 기록 있으면 챙기기" ,
                        description = "있다면 상담에 도움을 줄 수 있어요.")
                    Spacer(modifier = Modifier.height(10.dp))
                    Tips(title ="센터 위치, 연락처 확인" ,
                        description = "당일 헷갈리지 않게 미리 확인해요.")
                    Spacer(modifier = Modifier.height(10.dp))
                    Tips(title ="긴장하지 않기로 마음 먹기" ,
                        description = "잘 말하려 애쓰지 않아도 괜찮아요.")
                    Spacer(modifier = Modifier.height(10.dp))
                    Tips(title ="카페인/자극적인 뉴스 피하기" ,
